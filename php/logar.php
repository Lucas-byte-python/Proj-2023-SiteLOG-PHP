...
if(isset($_POST['email']) || isset($_POST['senha'])) {
    ...
    if(strlen($_POST['email']) == 0) {
        ...
        $sql_code = "SELECT * FROM cadastro_usu email = '$email' AND senha ='$senha'";
        ...
        if($quantidade == 1) {
            ...
            header("Location: protecaotela.php");
        } else {
...
<header class="menu">
	<ul>
		...
		<li><a href="transportadora.html">Transportadora</a></li>
		<li><a href="home_site.html">Home</a></li>
	</ul>
